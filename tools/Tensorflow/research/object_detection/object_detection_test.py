...
flags = tf.app.flags
flags.DEFINE_string('image_dir', '', 'Path de la imagen')
...
def main(_):
    ...
    # checar que label_map se cree desde la interfaz y cambiarlo por "mesas_label_map.bptxt"
...
# If you want to test the code with your images, just add path to the images to the TEST_IMAGE_PATHS.
    ...
    #PATH_TO_TEST_IMAGES_DIR = '/home/gustavo/Documentos/LKE_framework/data/classification/image4.jpg'
    #print('PATH_TO_TEST_IMAGES_DIR = {}'.format(PATH_TO_TEST_IMAGES_DIR))
    ...
    for image_path in TEST_IMAGE_PATHS:
        ...
        cv2.imshow('{}'.format(os.path.basename(image_path)), cv2.resize(image_np, (800, 600)))
